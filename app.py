...
def display_backtest_results(bt_results, picks_df, prices_df, benchmark_series, historical_info, 
    ...
    if picks_df is not None and not picks_df.empty:
        ...
        with col_main:
            ...
            if all(col in date_picks_display.columns for col in display_columns):
...
# Ejecutar verificación de archivos históricos
    ...
    try:
        ...
        if not use_cache:
            ...
            try:
                ...
                # Debug y fallback si son muy pocos tickers
                if len(tickers) < 50:
